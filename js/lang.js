const translations = {
    en: {
        ...
        bullet_dca: "Coded a probabilistic decline curve analysis feature to apply risk to working forecasts, improving forecast reliability and decision-making.",
        bullet_sql: "Manage the planning database using SQL to maintain well schedules, historical data, and forecasts, supporting accurate planning and cross-team collaboration.",
        bullet_batrat: "Developed a battery volatility metric to evaluate operator pump ratability, supporting a successful challenge that led the operator to drop a proposed $1M charge.",
        bullet_pipe_costs: "Created a pipeline cost forecasting model using probability and risk analysis to support better project decisions.",
        bullet_samsara: "Pulled vehicle route data from the Samsara API and analyzed efficiency to improve operational logistics.",
        ...
        bullet_auto_chi: "Built a Python package for trend-fitting and anomaly detection in seismic data.",
        bullet_mai: "Designed AI-driven subsurface tools for multiple business units, cutting interpretation time from weeks to days.",
    ...
    es: {
        ...
        bullet_dca: "Programé una función probabilística de análisis de curvas de declinación para aplicar riesgo a las previsiones de producción, mejorando la confiabilidad del pronóstico y la toma de decisiones.",
        bullet_sql: "Gestiono la base de datos de planificación usando SQL para mantener los cronogramas de pozos, datos históricos y pronósticos, apoyando una planificación precisa y la colaboración entre equipos.",
        bullet_batrat: "Desarrollé una métrica de volatilidad de baterías para evaluar la capacidad de bombeo de los operadores, lo que respaldó con éxito un reclamo que llevó al operador a cancelar un cargo propuesto de $1M.",
        bullet_pipe_costs: "Creé un modelo de pronóstico de costos de ductos utilizando análisis de probabilidad y riesgo para respaldar mejores decisiones de proyecto.",
        bullet_samsara: "Extraje datos de rutas de vehículos desde la API de Samsara y analicé la eficiencia para mejorar la logística operativa.",
        ...
        bullet_auto_chi: "Desarrollé un paquete de Python para ajuste de tendencias y detección de anomalías en datos sísmicos.",
        bullet_mai: "Diseñé herramientas subsuperficiales impulsadas por IA para varias unidades de negocio, reduciendo el tiempo de interpretación de semanas a días.",
    ...
    it: {
        ...
        bullet_dca: "Ho programmato una funzionalità probabilistica per l’analisi delle curve di declino per applicare il rischio alle previsioni di produzione, migliorando l’affidabilità delle stime e il processo decisionale.",
        bullet_sql: "Gestisco il database di pianificazione utilizzando SQL per mantenere i programmi dei pozzi, i dati storici e le previsioni, supportando una pianificazione accurata e la collaborazione tra team.",
        bullet_batrat: "Ho sviluppato una metrica di volatilità delle batterie per valutare la regolarità di pompaggio degli operatori, supportando con successo una contestazione che ha portato l’operatore ad annullare un addebito proposto da 1 milione di dollari.",
        bullet_pipe_costs: "Ho creato un modello di previsione dei costi delle condotte utilizzando l’analisi del rischio e della probabilità per supportare decisioni progettuali migliori.",
        bullet_samsara: "Ho estratto i dati dei percorsi dei veicoli dall’API di Samsara e analizzato l’efficienza per migliorare la logistica operativa.",
        ...
        bullet_auto_chi: "Ho sviluppato un pacchetto Python per il fitting di trend e la rilevazione di anomalie nei dati sismici.",
        bullet_mai: "Ho progettato strumenti subsuperficiali basati su IA per diverse unità aziendali, riducendo i tempi di interpretazione da settimane a giorni.",
    ...
    ja: {
        ...
        bullet_dca: "リスクを稼働中の予測に適用するための確率的減衰曲線分析機能を開発し、予測の信頼性と意思決定を向上させました。",
        bullet_sql: "SQLを使用して計画データベースを管理し、井戸スケジュール、過去データ、および予測を維持し、正確な計画とチーム間の連携を支援しています。",
        bullet_batrat: "オペレーターのポンプ操作の安定性を評価するためのバッテリー変動性指標を開発し、100万ドルの請求を撤回させた成功した異議申し立てを支援しました。",
        bullet_pipe_costs:"確率とリスク分析を活用したパイプラインコスト予測モデルを作成し、より良いプロジェクト判断を支援しました。",
        bullet_samsara: "Samsara APIから車両ルートデータを取得・分析し、業務ロジスティクスの効率を改善しました。",
        ...
        bullet_auto_chi: "地震データのトレンドフィッティングと異常検出のためのPythonパッケージを構築しました。",
        bullet_mai: "複数の事業部門向けにAI駆動の地中解析ツールを設計し、解釈時間を数週間から数日へ短縮しました。",
