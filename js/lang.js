const translations = {
    en: {
        ...
        assignment_1: "Used the Samsara API to extract detailed route data for the company's fleet of vehicles, enabling comprehensive analysis of route efficiency and driver performance to optimize logistics and reduce operational costs.",
        assignment_2: "Expedited QA/QC process for volumetric readings by constructing automated workflow to detect anomalous values. Reduced cycle time by 75%+.",
        assignment_3: "Regular utilization of Python, SQL, Azure, GitHub & CI/CD practices, FastAPI, Docker, and Spotfire.",
        ...
        assignment_4: "Re-characterized subsurface architecture for OL385E reservoir in the Rovuma Basin, Mozambique, and successfully passed subsurface peer review with Senior Technical Committee.",
        assignment_5: "Developed and programmed internal Python package for trend-fitting and anomaly detection with seismic data.",
        assignment_6: "Designed and implemented machine learning solutions (regression, classification, deep learning, etc.) in support of various BUs across the Upstream organization.",
        assignment_7: "Evaluated the use of ArcGIS StoryMaps for knowledge capture and documentation across the Upstream organization.",
    ...
    es: {
        ...
        assignment_1: "Utilizó la API de Samsara para extraer datos detallados de rutas para la flota de vehículos de la empresa, permitiendo un análisis exhaustivo de la eficiencia de las rutas y el rendimiento de los conductores para optimizar la logística y reducir los costos operativos.",
        assignment_2: "Aceleró el proceso de QA/QC para lecturas volumétricas construyendo un flujo de trabajo automatizado para detectar valores anómalos. Redujo el tiempo del ciclo en más del 75%.",
        assignment_3: "Uso regular de Python, SQL, Azure, GitHub y prácticas de CI/CD, FastAPI, Docker y Spotfire.",
        ...
        assignment_4: "Re-caracterizó la arquitectura subsuperficial para el reservorio OL385E en la cuenca Rovuma, Mozambique, y pasó exitosamente la revisión de pares subsuperficiales con el Comité Técnico Senior.",
        assignment_5: "Desarrolló y programó un paquete interno de Python para ajuste de tendencias y detección de anomalías con datos sísmicos.",
        assignment_6: "Diseñó e implementó soluciones de aprendizaje automático (regresión, clasificación, aprendizaje profundo, etc.) en apoyo a varias unidades de negocio en la organización Upstream.",
        assignment_7: "Evaluó el uso de ArcGIS StoryMaps para la captura de conocimientos y documentación en toda la organización Upstream.",
    ...
    it: {
        ...
        assignment_1: "Utilizzato l'API di Samsara per estrarre dati dettagliati sui percorsi per la flotta di veicoli dell'azienda, consentendo un'analisi completa dell'efficienza dei percorsi e delle prestazioni dei conducenti per ottimizzare la logistica e ridurre i costi operativi.",
        assignment_2: "Accelerato il processo di QA/QC per le letture volumetriche costruendo un flusso di lavoro automatizzato per rilevare valori anomali. Ridotto il tempo del ciclo del 75%+.",
        assignment_3: "Utilizzo regolare di Python, SQL, Azure, GitHub e pratiche CI/CD, FastAPI, Docker e Spotfire.",
        ...
        assignment_4: "Re-caratterizzato l'architettura del sottosuolo per il giacimento OL385E nella bacino Rovuma, Mozambico, e superato con successo la revisione del sottosuolo con il Comitato Tecnico Senior.",
        assignment_5: "Sviluppato e programmato un pacchetto Python interno per l'adattamento delle tendenze e la rilevazione delle anomalie con i dati sismici.",
        assignment_6: "Progettato e implementato soluzioni di machine learning (regressione, classificazione, apprendimento profondo, ecc.) a supporto di varie BU all'interno dell'organizzazione Upstream.",
        assignment_7: "Valutato l'uso di ArcGIS StoryMaps per la cattura della conoscenza e la documentazione all'interno dell'organizzazione Upstream.",
    ...
    ja: {
        ...
        assignment_1: "Samsara APIを使用して、同社の車両フリートの詳細なルートデータを抽出し、ルート効率とドライバーのパフォーマンスの包括的な分析を可能にし、物流の最適化と運用コストの削減を実現しました。",
        assignment_2: "異常値を検出する自動化されたワークフローを構築し、体積測定のQA/QCプロセスを迅速化しました。サイクルタイムを75%以上短縮しました。",
        assignment_3: "Python、SQL、Azure、GitHub & CI/CDの実践、FastAPI、Docker、Spotfireを日常的に使用しています。",
        ...
        assignment_4: "モザンビークのロヴマ盆地にあるOL385E貯留層の地下構造を再評価し、上級技術委員会による地下 peer review を成功裏に通過しました。",
        assignment_5: "地震データのトレンド適合と異常検出のための内部Pythonパッケージを開発・プログラムしました。",
        assignment_6: "Upstream組織のさまざまなビジネスユニットをサポートするために、機械学習ソリューション（回帰、分類、深層学習など）を設計・実装しました。",
        assignment_7: "ArcGIS StoryMapsを評価し、Upstream組織全体での知識のキャプチャと文書化を行いました。",
        education_title: "教育",
